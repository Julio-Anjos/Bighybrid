#ifndef TASK_BIGHYBRID_HEADER
#define TASK_BIGHYBRID_HEADER
...
class Task_BigHybrid 
{
    ...
    public:
    Task_BigHybrid(std::string task_name, double comp_size, double comm_size, void* task_data);
