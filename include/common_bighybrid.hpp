...
#ifndef BIGHYBRID_COMMON_HEADER
#define BIGHYBRID_COMMON_HEADER
...
extern struct mra_dist_mang_s { /*NEW*/
       int min_tot_dist;
       int max_tot_dist;
       int*  total_dist;
} mra_dist_manage;
...
extern struct mra_config_s { /*NEW*/
    ...
    simgrid::s4u::Host** workers_mra; /*NEW*/
} config_mra;

/*NEW*/typedef Task_BigHybrid* bighybrid_task_t;
...
extern struct mra_job_s {
    ...
    /*NEW*/ bighybrid_task_t** task_list[2];
    size_t**      	map_output;
...
struct mrsg_task_info_s {
    ...
    size_t        mrsg_wid;
    int           mrsg_pid;
    /*OLD msg_task_t    mrsg_task;*/
    /*NEW*/Task_BigHybrid* mrsg_task;
    size_t*       map_output_copied;
    double        shuffle_mrsg_end;
    /*NEW*/int           mrsg_size_data_proc;
};
 ...
 */
/*CHANGED*/ void mra_send (const char* str, double cpu, double net, void* data, const char* mailbox);
 ...
 * @return The MSG status of the operation.
 */
/*CHANGED*/ void send (const char* str, double cpu, double net, void* data, const char* mailbox);
 ...
 */
/*CHANGED*/ void send_mrsg_sms (const char* str, const char* mailbox);
 ...
 */
/*CHANGED*/ bighybrid_task_t mra_receive (/*OLD msg_task_t* msg_mra,*/ const char* mailbox);
 ...
 * @return The status of the transfer.
 */
/*CHANGED*/ bighybrid_task_t receive (/*OLD msg_task_t* msg,*/ const char* mailbox);
 ...
 */
/*CHANGED*/ int mra_message_is (bighybrid_task_t msg_mra, const char* str);
/*CHANGED*/int mrsg_message_is (bighybrid_task_t msg, const char* str);
